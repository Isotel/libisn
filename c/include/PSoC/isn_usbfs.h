 ...
 * - PSoC5: Use VBUS Monitoring for automatic USB Connection/Disconnection detection
 *
...
/** If VBUS Monitoring is used by the USBFS component */
extern void isn_usbfs_state_cb(uint8_t usb_state);
 ...
 * \returns non zero if successfully connected
 */
